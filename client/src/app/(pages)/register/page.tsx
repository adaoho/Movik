...
const RegisterPage = () => {
  const onSubmitRegister = async (formData: FormData) => {
    ...
    console.log(formData.get("name"), "<<< name");
    console.log(formData.get("username"), "<<< username");
  ...
  return (
    <>
      <div className="h-screen w-screen items-center flex justify-center bg-gray-100">
        <div className="flex flex-row justify-center items-center h-[550px] w-[800px] relative">
          {/* Col Span 1 */}
          ...
          <div className="relative flex flex-col text-gray-700 bg-white shadow-lg w-96 rounded-r-xl bg-clip-border h-full justify-center">
            <div className="flex flex-col w-full items-center">
              ...
              />
              <p className="text-sm -mt-8">Register Your Account</p>
            </div>
            <form className="flex flex-col gap-4 p-6" action={onSubmitRegister}>
